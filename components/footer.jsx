...
export default function Footer() {
  return (
    <footer id="contact" className="w-full bg-black  py-12 px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="flex flex-col items-center lg:items-start">
            <div className="flex items-center gap-3 mb-4">
              <h2 className="text-2xl font-bold text-white">CoursePlus</h2>
            </div>
            ...
            <div className="mt-6 flex gap-4 justify-center lg:justify-start">
              <a href="#" className="w-10 h-10 rounded-full border border-gray-300 flex items-center justify-center text-gray-300 hover:bg-gray-100 transition-colors">
                <Twitter size={18} />
              </a>
              <a href="#" className="w-10 h-10 rounded-full border border-gray-300 flex items-center justify-center text-gray-300 hover:bg-gray-100 transition-colors">
                <Facebook size={18} />
          ...
          <div>
            <h3 className="font-semibold text-xl mb-4 text-gray-300">Quick Links</h3>
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-300 hover:text-blue-500 transition-colors">Home</a></li>
              <li><a href="#" className="text-gray-300 hover:text-blue-500 transition-colors">Courses</a></li>
          ...
          <div>
            <h3 className="font-semibold text-xl mb-4 text-gray-300">Resources</h3>
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-300 hover:text-blue-500 transition-colors">Mentors</a></li>
          ...
          <div>
            <h3 className="font-semibold text-xl mb-4 text-gray-300">Contact Us</h3>
            <ul className="space-y-3">
              <li className="flex items-center gap-3 text-gray-300">
                <Phone size={18} className="text-gray-600" />
                <span>+917682860128</span>
              </li>
              <li className="flex items-center gap-3 text-gray-300">
